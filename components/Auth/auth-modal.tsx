        ...
        <>
          ...
          >
            ...
            <motion.div
              ...
              className="bg-slate-900 border border-emerald-500/20 rounded-2xl p-6 w-full max-w-sm shadow-2xl relative overflow-y-auto max-h-[90vh] mt-50 scrollbar-hide"
